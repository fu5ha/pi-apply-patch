...
export const GPT_APPLY_PATCH_PROVIDERS = new Set([
    "openai",
    "openai-codex",
...
export const PATCH_PREVIEW_HEAD_LINES = 8;
export const PATCH_PREVIEW_TAIL_LINES = 8;
export const PATCH_COLLAPSED_DIFF_LINES = 10;
export const STANDARD_EDIT_TOOL_NAMES = ["edit", "write"] as const;
